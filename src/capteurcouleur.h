...
if (color.red > 1000 && color.green > 1000 && color.blue > 1000 && color.clear > 1000) {
    Serial.print("blanc : ");
}else if (color.red > 1000 && color.green > 1000 && color.blue < 1000 && color.clear > 1000) {
    Serial.print("orange flash : ");
}else if (color.red < 1000 && color.green > 1000 && color.blue > 1000 && color.clear > 1000) {
    Serial.print("vert flash : ");
}
